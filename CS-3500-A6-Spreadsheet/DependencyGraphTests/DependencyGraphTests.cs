...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        /// Testing AddDependency and checking if size has increased.
        /// Checking RemoveDependency and checking if size has decreased.
        /// </summary>
        [TestMethod()]
        ...
        /// <summary>
        /// Adding dependency and checking for dependents. 
        /// </summary>
        [TestMethod()]
        public void testSimpleHasDependents()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("x", "y");
            Assert.AreEqual(1, t.Size);
        ...
        /// <summary>
        /// Adding dependency and checking for dependees. 
        /// </summary>

        [TestMethod()]
        public void testSimpleTrueHasDependees()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("x", "y");
            Assert.AreEqual(1, t.Size);
        ...
        /// <summary>
        /// Adding new depencedies and check if they exist.
        /// </summary>
        [TestMethod()]
